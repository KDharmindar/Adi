...
//Array of Functions
let shapes = []; //Blank array of functions
let shapeParameters = []; // Blank array of array for parameters
...
function ExecuteDraw(drawFunc, param) {
