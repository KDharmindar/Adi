...
*/
let profitRatePerMonth:number; // It is a monthly profit rate
let investmentAmount:number; // Investment amount
let profitAmount:number; // Amount of profit calculated 
let futureValue:number; // Amount after adding profit
let periodInYears:number; // Investment period
let numberOfMonths:number;// total number of months in the period
let currentMonthProfit:number// Profit amount for current month
let currentDetails:string = '';//Variable for string representation in console
